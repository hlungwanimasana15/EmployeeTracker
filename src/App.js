        ...
        <div className='form-container' >
          <form className='form-group' onSubmit={handleAddEmployeeinfo}>
            ...
            <input type="text" className='form-control' required
              onChange={(e) => setNameSurname(e.target.value)} value={namesurname}
            ...
            <input type="text" className='form-control' required
              onChange={(e) => setEmployeePosition(e.target.value)} value={employeeposition}

            ></input>
            <br></br>
            <label>Phone Number</label>
            <input type="text" className='form-control' required
              onChange={(e) => setIdPhoneNumber(e.target.value)} value={phonenumber}

            ></input>
            <br></br>
            <label>Image</label>
            <input type="file"onChange={() => setImage([])} className='form-control' ></input>
            <br></br>
        ...
        <div className='view-container'>
          {employees.length > 0 && <>
            <table>
              ...
              <tbody>
                <EmployeeList handleEdit={handleEdit} employees={employees} deleteEmployeeinfo={deleteEmployeeinfo} />
              </tbody>
            </table>
            <button className='btn-update' type='button' onClick={handleUpdate}>Update info</button>
            <button className='btn-clear' onClick={() => setEmployees([])}>Clear All</button>
          </>}
